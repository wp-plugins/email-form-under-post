        ...
        <tbody>
          <tr class="mandrill-hide" <?php if( get_option( 'post_email_api_need' ) == 0 ) { ?>style="display:none;"<?php } ?>>
            <td width="200"><?php _e( 'Mandrill API KEY :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="post_email_api" value="<?php echo get_option('mandrill_emailer_api_key') ?>">
          ...
          <tr class="mandrill-hide" <?php if( get_option( 'post_email_api_need' ) == 0 ) { ?>style="display:none;"<?php } ?>>
            <td width="200"><?php _e( 'Mandrill Email Template :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="post_email_template" value="<?php echo get_option('post_email_template') ?>">
          ...
          <tr class="mandrill-hide" <?php if( get_option( 'post_email_api_need' ) == 0 ) { ?>style="display:none;"<?php } ?>>
            <td width="200"><?php _e( 'Mandrill User Name :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="mandrill_emailer_username" value="<?php echo get_option('mandrill_emailer_username') ?>">
          ...
          <tr>
            <td width="115"><?php _e( 'From Name :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="mandrill_emailer_from_name" value="<?php echo get_option('mandrill_emailer_from_name') ?>">
          ...
          <tr>
            <td width="115"><?php _e( 'From Email :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="mandrill_emailer_from_email" value="<?php echo get_option('mandrill_emailer_from_email') ?>">
        ...
        <tbody>
          <tr>
            <td width="200"><?php _e( 'ReCAPTCHA Public KEY :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="recaptcha_public" value="<?php echo get_option('recaptcha_public') ?>">
          ...
          <tr>
            <td width="200"><?php _e( 'ReCAPTCHA Private KEY :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="recaptcha_private" value="<?php echo get_option('recaptcha_private') ?>">
          ...
          <tr>
            <td width="200"><?php _e( 'Success Message When email send  :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="post_email_success" value="<?php echo get_option('post_email_success') ?>">
          ...
          <tr>
            <td width="200"><?php _e( 'Error message when email fail to send :', 'post-email' ); ?></td>
              <td width="877">
                <input type="text" name="post_email_error" value="<?php echo get_option('post_email_error') ?>">
